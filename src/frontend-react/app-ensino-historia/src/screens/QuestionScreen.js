...
const QuestionScreen = () => {
    ...
    const defaultQuestions = [
        {
            text: "Qual era a capital do Império Romano?",
            options: ["Atenas", "Roma", "Constantinopla", "Cartago"],
            correctAnswer: 1
        }
    ];

    const questions = route.params?.questions?.length > 0 ? route.params.questions : defaultQuestions;
